...
// import { useAuth } from "../../context/authcontext"; // Uncomment if running in original environment
...
const Ianeyerlestir = () => {
  ...
  const { postiane } = useAuth(); // Assuming useAuth is available
  ...
  const sendIaneRequest = async (e) => {
    ...
    try {
      ...
      // Backend'e gönderme
      const result = await postiane(basliq, movzu, amount, photos, bitir);
